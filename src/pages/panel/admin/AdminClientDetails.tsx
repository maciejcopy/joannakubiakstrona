...
export const AdminClientDetails: React.FC = () => {
  ...
  if (loading) {
    return (
      <PanelLayout title="Profil Klienta" role="admin" sidebarItems={adminSidebarItems}>
  ...
  return (
    <PanelLayout title={`Karta Klienta: ${profile.full_name}`} role="admin" sidebarItems={adminSidebarItems}>
